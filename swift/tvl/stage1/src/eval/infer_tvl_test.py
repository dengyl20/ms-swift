...
DEFAULT_INFER_OUT_DIR = os.path.join(DEFAULT_PREPROC_ROOT, "infer_results_epoch_007")

DEFAULT_AE_CKPT = "/vast/users/guangyi.chen/causal_group/yunlong.deng/Multimodal/ms-swift/swift/checkpoints/tvl/stage1/1/epoch_007.pt"
    ...
    *,
    ...
    for i in range(len(ds)):
        ...
        try:
            ...
            print(f"gt is : {gt}, pred is : {pred},index is {i}")
            rows.append(
                {
                    **base,
                    "question": question,
